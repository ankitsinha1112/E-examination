...
<body>
  ...
  <body id="myPage" data-spy="scroll" data-target=".navbar" data-offset="60">
    ...
    <div id="developers" class="container-fluid text-center bg-grey">
      <h2>Developers</h2><br>
      <h4>Who are we</h4>
      <div class="row text-center slideanim" style="display : flex; justify-content : center;">
        <div class="col-sm-4">
          <div class="thumbnail">
            <img src="my_img.jpeg" alt="Ankit Kumar Sinha" width="400" height="300">
            <p><strong>Ankit Kumar Sinha</strong></p>
            <p>A Full Stack Web Developer (Software Engineer)</p>
            <p>A growing full stack web developer, who specializes in building
              web applications for the best digital experiences. I am keenly focused 
              on building impactful products which can create value in people's lives.
               Skilled in HTML, CSS, JavaScript, ExpressJS, Wordpress, ReactJS, MongoDB, SpringBoot, PHP, MySQL and Nodejs.
                I'm looking forward to opportunities that will help me grow so that I keep contributing my part in this 
                beautiful field of technology.</p>
          </div>
        </div>
        <!-- <div class="col-sm-4">
          <div class="thumbnail">
    ...
    <div id="contact" class="container-fluid bg-grey">
      ...
      <div class="row">
        <div class="col-sm-5">
          ...
          <p><span class="glyphicon glyphicon-map-marker"></span>Bangalore, Karnataka, India</p>
          <p><span class="glyphicon glyphicon-phone"></span> +91 9905025929 </p>
          <p><span class="glyphicon glyphicon-envelope"></span> ankitsinha111200@gmail.com</p>
        </div>
      ...
      <div class="row">
        ...
        <div class="col-sm-6 form-group">
        <input class="form-control" id="comments" name="subject" placeholder="Subject" type="text" required>
        </div>
        </div>
